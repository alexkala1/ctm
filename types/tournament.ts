...
export function isTournamentStatus(value: unknown): value is TournamentStatus {
  return (
    typeof value === 'string' &&
    ['DRAFT', 'OPEN', 'IN_PROGRESS', 'FINISHED'].includes(value)
  )
}
...
export function isPlayerAcceptanceStatus(
  value: unknown
): value is PlayerAcceptanceStatus {
  return (
    typeof value === 'string' &&
...
export function isUserRole(value: unknown): value is UserRole {
  return (
    typeof value === 'string' &&
    ['SUPER_ADMIN', 'ADMIN', 'USER'].includes(value)
  )
}
