...
export interface UpdateTournamentFormData extends Partial<CreateTournamentFormData> {
  id: string;
}
...
export interface UpdateCompetitorFormData extends Partial<CreateCompetitorFormData> {
  id: string;
}
