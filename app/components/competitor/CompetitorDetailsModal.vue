<template>
  <div v-if="competitor" class="space-y-6">
    ...
    >
      <div class="flex items-center space-x-4 mb-4">
        <div class="w-8 h-8 bg-blue-100 dark:bg-blue-900/30 rounded-lg flex items-center justify-center">
          <Icon name="i-heroicons-user" class="w-5 h-5 text-blue-600 dark:text-blue-400" />
        </div>
      ...
      <div class="flex items-center space-x-6">
        ...
        <div class="flex-1 min-w-0">
          <div class="flex items-center space-x-3 mb-2">
            ...
            <UiStatusBadge :status="competitor.playerAcceptanceStatus" variant="solid" size="sm" />
          </div>
          ...
          <div class="flex flex-wrap gap-2">
            ...
            >
              <Icon name="i-heroicons-hashtag" class="w-3 h-3 mr-1" />
      ...
      <div class="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm">
        <div class="flex items-center space-x-3 mb-4">
          <div class="w-8 h-8 bg-emerald-100 dark:bg-emerald-900/30 rounded-lg flex items-center justify-center">
            <Icon name="i-heroicons-user" class="w-5 h-5 text-emerald-600 dark:text-emerald-400" />
          </div>
        ...
        <div class="space-y-3">
          <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
            <div class="flex items-center space-x-2">
              <Icon name="i-heroicons-user-circle" class="w-4 h-4 text-gray-500 dark:text-gray-400" />
          ...
          >
            <div class="flex items-center space-x-2">
              <Icon name="i-heroicons-users" class="w-4 h-4 text-gray-500 dark:text-gray-400" />
      ...
      <div class="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm">
        <div class="flex items-center space-x-3 mb-4">
          <div class="w-8 h-8 bg-green-100 dark:bg-green-900/30 rounded-lg flex items-center justify-center">
            <Icon name="i-heroicons-document-text" class="w-5 h-5 text-green-600 dark:text-green-400" />
          </div>
        ...
        <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
          <Icon
            :name="competitor.tournamentDocumentUrl ? 'i-heroicons-document-check' : 'i-heroicons-document'"
            class="w-4 h-4"
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm">
      <div class="flex items-center space-x-3 mb-4">
        <div class="w-8 h-8 bg-orange-100 dark:bg-orange-900/30 rounded-lg flex items-center justify-center">
          <Icon name="i-heroicons-shield-check" class="w-5 h-5 text-orange-600 dark:text-orange-400" />
        </div>
      ...
      <div class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg min-h-[60px] flex items-center">
        ...
        <div v-else class="w-full text-center">
          ...
          />
          <p class="text-sm text-gray-500 dark:text-gray-400 font-medium">No admin notes available</p>
        </div>
      </div>
    </div>
    ...
    >
      <div class="flex items-center space-x-3 mb-4">
        ...
        <div>
          ...
          <p class="text-sm text-gray-600 dark:text-gray-400">This competitor is waiting for admin approval</p>
        </div>
      </div>
