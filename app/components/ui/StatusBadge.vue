...
const variantClasses = computed(() => {
  ...
  const colorClasses = {
    solid: {
      amber: 'bg-gradient-to-r from-amber-500 via-amber-600 to-amber-700 dark:from-amber-600 dark:via-amber-700 dark:to-amber-800',
      emerald: 'bg-gradient-to-r from-emerald-500 via-emerald-600 to-emerald-700 dark:from-emerald-600 dark:via-emerald-700 dark:to-emerald-800',
      rose: 'bg-gradient-to-r from-rose-500 via-rose-600 to-rose-700 dark:from-rose-600 dark:via-rose-700 dark:to-rose-800',
      violet: 'bg-gradient-to-r from-violet-500 via-violet-600 to-violet-700 dark:from-violet-600 dark:via-violet-700 dark:to-violet-800',
      ...
      slate: 'bg-gradient-to-r from-slate-500 via-slate-600 to-slate-700 dark:from-slate-600 dark:via-slate-700 dark:to-slate-800'
    },
    soft: {
      amber: 'bg-gradient-to-r from-amber-100 via-amber-200 to-amber-300 dark:from-amber-800/50 dark:via-amber-700/40 dark:to-amber-600/30 text-amber-900 dark:text-amber-100 border-amber-300/70 dark:border-amber-500/50',
      emerald: 'bg-gradient-to-r from-emerald-100 via-emerald-200 to-emerald-300 dark:from-emerald-800/50 dark:via-emerald-700/40 dark:to-emerald-600/30 text-emerald-900 dark:text-emerald-100 border-emerald-300/70 dark:border-emerald-500/50',
      ...
      violet: 'bg-gradient-to-r from-violet-100 via-violet-200 to-violet-300 dark:from-violet-800/50 dark:via-violet-700/40 dark:to-violet-600/30 text-violet-900 dark:text-violet-100 border-violet-300/70 dark:border-violet-500/50',
      ...
      slate: 'bg-gradient-to-r from-slate-100 via-slate-200 to-slate-300 dark:from-slate-800/50 dark:via-slate-700/40 dark:to-slate-600/30 text-slate-900 dark:text-slate-100 border-slate-300/70 dark:border-slate-500/50'
    },
    outline: {
      amber: 'ring-2 ring-amber-400 dark:ring-amber-500 text-amber-800 dark:text-amber-200 hover:bg-amber-100 dark:hover:bg-amber-800/20 hover:ring-amber-500 dark:hover:ring-amber-400',
      emerald: 'ring-2 ring-emerald-400 dark:ring-emerald-500 text-emerald-800 dark:text-emerald-200 hover:bg-emerald-100 dark:hover:bg-emerald-800/20 hover:ring-emerald-500 dark:hover:ring-emerald-400',
      ...
      violet: 'ring-2 ring-violet-400 dark:ring-violet-500 text-violet-800 dark:text-violet-200 hover:bg-violet-100 dark:hover:bg-violet-800/20 hover:ring-violet-500 dark:hover:ring-violet-400',
      ...
      slate: 'ring-2 ring-slate-400 dark:ring-slate-500 text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800/20 hover:ring-slate-500 dark:hover:ring-slate-400'
    }
  }
