<template>
  <div class="modern-alert">
    ...
    <div class="flex p-6 relative z-10">
      ...
      <!-- Content -->
      <div class="flex-1">
        <h3 v-if="title" class="text-lg font-bold mb-2" :class="titleClass">
          {{ title }}
        </h3>
        <p v-if="description" class="opacity-90" :class="descriptionClass">
          {{ description }}
        </p>

        <!-- Actions -->
        <div v-if="actions && actions.length > 0" class="mt-2 flex space-x-2">
          <UButton
