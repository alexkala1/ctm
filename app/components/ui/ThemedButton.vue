...
const buttonClasses = computed(() => {
  const baseClasses = 'focus:outline-none focus-visible:outline-0 disabled:cursor-not-allowed disabled:opacity-75 relative overflow-hidden group font-medium rounded-lg transition-all duration-200'
  ...
  const variantClasses = {
    primary: {
      solid: 'bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white shadow-sm hover:shadow-md',
      outline: 'border border-blue-600 text-blue-600 dark:text-blue-400 bg-transparent hover:bg-blue-50 dark:hover:bg-blue-400/10',
    ...
    success: {
      solid: 'bg-emerald-600 hover:bg-emerald-700 dark:bg-emerald-500 dark:hover:bg-emerald-600 text-white shadow-sm hover:shadow-md',
      outline: 'border border-emerald-600 text-emerald-600 dark:text-emerald-400 bg-transparent hover:bg-emerald-50 dark:hover:bg-emerald-400/10',
    ...
    warning: {
      solid: 'bg-amber-600 hover:bg-amber-700 dark:bg-amber-500 dark:hover:bg-amber-600 text-white shadow-sm hover:shadow-md',
      outline: 'border border-amber-600 text-amber-600 dark:text-amber-400 bg-transparent hover:bg-amber-50 dark:hover:bg-amber-400/10',
    ...
    error: {
      solid: 'bg-rose-600 hover:bg-rose-700 dark:bg-rose-500 dark:hover:bg-rose-600 text-white shadow-sm hover:shadow-md',
      outline: 'border border-rose-600 text-rose-600 dark:text-rose-400 bg-transparent hover:bg-rose-50 dark:hover:bg-rose-400/10',
    ...
    info: {
      solid: 'bg-cyan-600 hover:bg-cyan-700 dark:bg-cyan-500 dark:hover:bg-cyan-600 text-white shadow-sm hover:shadow-md',
      outline: 'border border-cyan-600 text-cyan-600 dark:text-cyan-400 bg-transparent hover:bg-cyan-50 dark:hover:bg-cyan-400/10',
    ...
    secondary: {
      solid: 'bg-slate-600 hover:bg-slate-700 dark:bg-slate-500 dark:hover:bg-slate-600 text-white shadow-sm hover:shadow-md',
      outline: 'border border-slate-600 text-slate-600 dark:text-slate-400 bg-transparent hover:bg-slate-50 dark:hover:bg-slate-400/10',
    ...
    neutral: {
      solid: 'bg-gray-600 hover:bg-gray-700 dark:bg-gray-500 dark:hover:bg-gray-600 text-white shadow-sm hover:shadow-md',
      outline: 'border border-gray-600 text-gray-600 dark:text-gray-400 bg-transparent hover:bg-gray-50 dark:hover:bg-gray-400/10',
  ...
  const colorClasses = variantClasses[props.color] || variantClasses.primary
  const variantClass = colorClasses[props.variant] || colorClasses.solid
...
const gapClasses = computed(() => {
  ...
  return gapSizes[props.size] || gapSizes.md
})
</script>
