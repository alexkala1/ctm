...
const cardClasses = computed(() => {
  ...
  const variantClasses = {
    ...
    gradient: [
      `bg-gradient-to-br from-${props.color}-400 via-${props.color}-500 to-${props.color}-600`,
    ...
    solid: [
      `bg-gradient-to-r from-${props.color}-50 to-${props.color}-100 dark:from-${props.color}-900/20 dark:to-${props.color}-800/20`,
      `text-${props.color}-800 dark:text-${props.color}-200`,
      `[&>*]:text-${props.color}-800 dark:[&>*]:text-${props.color}-200`,
