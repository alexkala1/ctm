    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl border border-red-200 dark:border-red-800 shadow-lg overflow-hidden">
      ...
      <div class="px-6 py-4">
        ...
        <div v-if="showDetails && errorDetails" class="mb-4">
          ...
          <div v-if="showDetailsExpanded" class="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
      ...
      <!-- Footer -->
      <div v-if="showFooter" class="bg-gray-50 dark:bg-gray-900/50 px-6 py-3 border-t border-gray-200 dark:border-gray-700">
