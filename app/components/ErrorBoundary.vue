...
const errorDescription = computed(() => errorInfo.value?.description || 'We encountered an error while loading this page.')
  ...
  switch (type) {
    ...
    case 'permission':
      return {
        ...
        description: 'It seems you don\'t have the necessary permissions to view this content. Please contact an administrator if you believe this is an error.',
