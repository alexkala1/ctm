<template>
  ...
  >
    <div class="w-full max-w-md">
      ...
      <!-- Status Messages -->
      <UAlert v-if="error" type="error" :title="error" class="mt-4" />

      <UAlert v-if="pendingMessage" type="info" :title="pendingMessage" class="mt-4" />
    </div>
  </div>
</template>
...
// OAuth methods - using direct API calls
